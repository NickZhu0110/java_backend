...
export CAC_RECALCULATE_PYTHON_EXECUTABLE="${CAC_RECALCULATE_PYTHON_EXECUTABLE:-$ROOT_DIR/python-worker/.venv/bin/python}"
export CAC_RECALCULATE_SCRIPT_PATH="${CAC_RECALCULATE_SCRIPT_PATH:-$ROOT_DIR/python-worker/recalculate_agatston.py}"
export CAC_STORAGE_ROOT="${CAC_STORAGE_ROOT:-$ROOT_DIR/storage}"
